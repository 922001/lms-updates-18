...
<body>
  ...
  <div class="wrapper">
    ...
    <div class="sidebar">
      ...
      ?>
      <li class="item">
        <a href="update_subjects.php?user_id=<?php echo $user['id']; ?>&subject_id=<?php echo $var_value; ?>"
          class="menu-btn">
          <i class="fas fa-edit"></i><span>Edit Subjects</span>
        </a>
      </li>
      <li class="item">
        <a href="admin_subjects.php?user_id=<?php echo $user['id']; ?>&department=<?php echo $department; ?>&semester=<?php echo $semester; ?>"
          class="menu-btn">
