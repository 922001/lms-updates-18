...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <li class="item">
                <a href="add_subjects.php?user_id=<?php echo $user['id']; ?>&subject_id=<?php echo $subjectId; ?>"
                    class="menu-btn">
                    <i class="fas fa-plus"></i><span>Add Subjects</span>
                </a>
            </li>
            <li class="item">
        <a href="update_subjects.php?user_id=<?php echo $user['id']; ?>&subject_id=<?php echo $subjectId; ?>"
          class="menu-btn">
